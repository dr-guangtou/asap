...
def logms_halo_from_logmh_log_linear(logmh,
                                     ...
                                     log_mass=True):
    r""" Power law model for total stellar mass in a halo as a function of
    halo mass.
    The output ``smtot`` variable includes stellar mass of the central,
    the IHM, and the also the total galaxy + IHM mass bound in satellites of
    the halo.
    ...
    logmh : float or ndarray
        ...
        calculated assuming little h equals the value appropriate for its
        cosmology)
    ...
    smtot : float or ndarray
        ...
        mass in the halo, including BCG, IHL and total satellite galaxy mass in
        units of Msun
    """
